...
4. [G2-02 Materialization 任务包](delivery/g2-02-materialization-task-pack.md)：**PASS（14/14）**，覆盖受管 CSV、Mapping、Job/Lease、Generation、Base/Current、Staging/Cutover、Index/Capacity、GC 与 clean-room 总验收；下一步只允许先创建并红队审查 G2-03 任务包。
