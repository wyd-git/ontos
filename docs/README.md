...
4. [G2-02 Materialization 任务包](delivery/g2-02-materialization-task-pack.md)：当前唯一获准实现的业务 Gate，覆盖受管 CSV、Mapping、Job/Lease、Generation、Base/Current、Staging/Cutover、Index/Capacity 与 GC；G2-02-01～06 已 PASS，下一顺序任务是 G2-02-07。
