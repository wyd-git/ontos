...
5. [G2-03 Query + Policy 任务包](delivery/g2-03-query-policy-task-pack.md)：**Frozen（0/15）**，覆盖 Runtime Identity/Delegation、Policy Compiler/Gateway、Get/Search/Count/Link/Cursor、Runtime Read OpenAPI Candidate 与真实只读 Web 消费者；当前只放行 G2-03-01。
