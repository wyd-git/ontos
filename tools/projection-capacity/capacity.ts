...
export function evaluateCapacity(
  ...
  const measuredBytes = sumBigInt(estimates.map((estimate) => estimate.measuredBytes));
  const reservedBytes = sumBigInt(estimates.map((estimate) => estimate.reservedBytes));
