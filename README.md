...
- G2-01 Metadata：**G2-01-01～10 已实现，进度 10/12**；
- 正式产品实现：**Metadata/Package 控制面已具备真实 OIDC、受限 HTTP 入口、最小 RBAC、PostgreSQL Repository、Release 原子发布和进程重启恢复**；
- 下一工作项：**G2-01-11 统一 CI、Testkit 与 Metadata Evidence**。
